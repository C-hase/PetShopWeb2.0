  ...
  <div>
    ...
    >
      ...
      <template v-slot:op="scope">
        <el-button type="primary" size="mini" @click="handleDeliver(scope)">接受</el-button>
        <el-button type="primary" size="mini" @click="handleCheck(scope)">拒绝</el-button>
      </template>
    </JsonTable>
  </div>
...
import {localService, options, searchColumns, tableColumns} from "@/components/JsonTable/OperatorbillPetConfig";
  ...
  setup(props, {emit}) {
    ...
    function handleDeliver(val){
      let obj = val.scope.store.states.data._value;
        ElMessageBox.confirm('是否接受订单', '提示', {
